...
#ifdef HWRENDER
	if ((rendermode == render_opengl && !cv_grpaletteshader.value) || (rendermode == render_opengl && gr_use_palette_shader && !cv_grflashpal.value))
...
#ifdef HWRENDER
		if (rendermode == render_soft || (rendermode == render_opengl && gr_use_palette_shader && cv_grflashpal.value))
#else
